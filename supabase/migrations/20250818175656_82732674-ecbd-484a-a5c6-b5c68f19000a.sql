-- Create or replace RPC to claim a QR code for a user and item
-- Ensures QR exists, item belongs to user, prevents duplicates, and records history
...
BEGIN
  -- Require authenticated user matches p_user_id
  ...
  -- Check if already linked for this user and qr
