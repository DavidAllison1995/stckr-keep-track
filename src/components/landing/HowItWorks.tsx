...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gray-50 max-[768px]:py-12 max-[768px]:px-3">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16 max-[768px]:mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto max-[768px]:text-base max-[768px]:max-w-none">
            Get organised in three simple steps — from physical items to digital peace of mind
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 md:gap-12 max-[768px]:grid-cols-1 max-[768px]:gap-4">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full bg-white max-[768px]:hover:-translate-y-0.5">
                <CardContent className="p-8 max-[768px]:p-5">
                  {/* Step Number */}
                  ...
                  {/* Visual */}
                  <div className="text-6xl mb-6 max-[768px]:text-4xl max-[768px]:mb-3">
                    {step.visual}
                  </div>
                  
                  {/* Content */}
                  <h3 className="text-xl font-bold text-gray-900 mb-4 max-[768px]:text-lg max-[768px]:mb-2">
                    {step.title}
                  </h3>
                  <p className="text-gray-600 leading-relaxed max-[768px]:text-sm max-[768px]:leading-normal">
                    {step.description}
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-lg border border-gray-100 max-[768px]:mt-8 max-[768px]:p-5 max-[768px]:rounded-xl">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-4 max-[768px]:text-xl max-[768px]:mb-3">
              Perfect for everything you own
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600 max-w-2xl mx-auto max-[768px]:grid-cols-2 max-[768px]:gap-2 max-[768px]:text-xs max-[768px]:max-w-none">
              <div>🚗 Cars & Bikes</div>
