...
const FeaturePillars = () => {
  ...
  return (
    <section className="py-20 px-4 bg-white max-[768px]:py-12 max-[768px]:px-3">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-[768px]:grid-cols-1 max-[768px]:gap-4">
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="p-8 text-center h-full flex flex-col max-[768px]:p-5">
                ...
                <p className="text-gray-600 leading-relaxed flex-grow max-[768px]:text-sm max-[768px]:leading-normal">
                  {feature.description}
                </p>
              </CardContent>
            </Card>
